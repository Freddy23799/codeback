...
public class SurveillantRepositoryImpl implements SurveillantRepositoryCustom {
    ...
    @Override
    public List<SurveillantListDTO> fetchSurveillantsLight(Long cursorId, int limit, String q) {
        ...
        var execQuery = (java.util.function.Function<Long, List<SurveillantListDTO>>) (maybeCursor) -> {
            ...
            return jdbc.query(sb.toString(), params.toArray(), new RowMapper<SurveillantListDTO>() {
                @Override
                public SurveillantListDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
                    SurveillantListDTO d = new SurveillantListDTO();
        ...
        List<SurveillantListDTO> rows = execQuery.apply(cursorId);
